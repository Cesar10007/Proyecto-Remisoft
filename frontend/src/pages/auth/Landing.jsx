      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <h1>
            ...
            <em>restaurante</em>
            <br />
            sin <span className="accent">complicaciones</span>
          </h1>
        ...
        <div className="hero-visual">
          <div className="mockup-frame">
            ...
            <div className="mockup-body">
              <div className="mockup-section-title">Panel de hoy</div>
              ...
              <div className="mockup-section-subtitle">Pedidos activos</div>
