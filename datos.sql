...
(1, 3, '2025-01-15 08:00:00', '2025-01-15 16:00:00', 200000, 850000, 845000, -5000, 'Turno mañana normal', 'CERRADA'),
(2, 7, '2025-01-15 08:00:00', '2025-01-15 16:00:00', 150000, 620000, 620000, 0, 'Sin novedades', 'CERRADA'),
(1, 3, '2025-01-15 16:00:00', '2025-01-15 23:59:00', 200000, 970000, 972000, 2000, 'Turno noche OK', 'CERRADA'),
(3, 7, '2025-01-16 08:00:00', NULL, 100000, NULL, NULL, NULL, 'Turno activo bar', 'ABIERTA'),
(2, 3, '2025-01-16 08:00:00', NULL, 150000, NULL, NULL, NULL, 'Turno activo caja 2', 'ABIERTA'),
(1, 7, '2025-01-14 08:00:00', '2025-01-14 16:00:00', 200000, 730000, 728000, -2000, 'Diferencia mínima', 'CERRADA'),
(4, 3, '2025-01-14 08:00:00', '2025-01-14 20:00:00', 50000, 480000, 480000, 0, 'Domicilios normales', 'CERRADA'),
(1, 7, '2025-01-13 08:00:00', '2025-01-13 16:00:00', 200000, 910000, 915000, 5000, 'Sobrante pequeño', 'CERRADA'),
(2, 3, '2025-01-13 16:00:00', '2025-01-13 23:59:00', 150000, 540000, 540000, 0, 'Todo cuadrado', 'CERRADA'),
(7, 7, '2025-01-16 10:00:00', NULL, 80000, NULL, NULL, NULL, 'Turno express activo', 'ABIERTA');
...
('Hamburguesa Clásica', 'Carne de res, lechuga, tomate, queso cheddar', 18000, 'HAMBURGUESAS', '00:12:00', 1),
('Pizza Margherita', 'Salsa de tomate, mozzarella, albahaca fresca', 32000, 'PIZZAS', '00:20:00', 1),
('Ensalada César', 'Lechuga romana, pollo, crutones, aderezo césar', 14000, 'ENSALADAS', '00:08:00', 1),
('Limonada Natural', 'Limón fresco, azúcar, agua, hielo', 6000, 'BEBIDAS', '00:03:00', 1),
('Papas Fritas', 'Papas a la francesa crujientes con sal', 7000, 'ACOMPAÑAMIENTOS', '00:10:00', 1),
('Pollo a la Plancha', 'Pechuga de pollo marinada con especias', 22000, 'PLATOS FUERTES', '00:15:00', 1),
('Pasta Carbonara', 'Espagueti, tocino, huevo, queso parmesano', 24000, 'PASTAS', '00:18:00', 1),
('Brownie con Helado', 'Brownie de chocolate con helado de vainilla', 12000, 'POSTRES', '00:05:00', 1),
('Sopa del Día', 'Varía según disponibilidad', 9000, 'SOPAS', '00:10:00', 1),
('Jugo Natural', 'Frutas de temporada', 7000, 'BEBIDAS', '00:04:00', 1);

-- INGREDIENTE
INSERT INTO Ingrediente (nombre, descripcion, unidad_medida, costo_unitario_ref, stock_minimo) VALUES
('Carne de Res Molida', 'Carne molida especial para hamburguesas', 'KG', 18000, 5),
('Harina de Trigo', 'Harina especial para masas', 'KG', 2500, 10),
('Queso Mozzarella', 'Queso para pizza y pastas', 'KG', 22000, 3),
('Lechuga Romana', 'Lechuga fresca para ensaladas', 'KG', 4000, 2),
('Tomate Chonto', 'Tomate fresco para salsas y ensaladas', 'KG', 3000, 3),
('Pechuga de Pollo', 'Pechuga entera sin hueso', 'KG', 14000, 4),
('Espagueti', 'Pasta seca importada', 'KG', 5500, 5),
('Huevo', 'Huevo fresco AA', 'UNIDAD', 450, 30),
('Limón Tahití', 'Limón para bebidas y aderezos', 'KG', 3500, 2),
('Papa Pastusa', 'Papa para freír y preparaciones', 'KG', 1800, 8);
...
(1, 'LOTE-CARNE-001', '2025-01-10', '2025-01-17', 20.000, 15.500, 18000, 'Lote fresco frigorífico central'),
(2, 'LOTE-HARINA-001', '2025-01-05', '2025-04-05', 50.000, 42.000, 2500, 'Harina de primera calidad'),
(3, 'LOTE-MOZZ-001', '2025-01-12', '2025-01-26', 10.000, 8.200, 22000, 'Mozzarella bloque'),
(4, 'LOTE-LECHUGA-001', '2025-01-14', '2025-01-19', 5.000, 4.100, 4000, 'Lechuga fresca del día'),
(5, 'LOTE-TOMATE-001', '2025-01-13', '2025-01-20', 8.000, 6.500, 3000, 'Tomate maduro selecto'),
(6, 'LOTE-POLLO-001', '2025-01-12', '2025-01-16', 15.000, 11.000, 14000, 'Pollo refrigerado'),
(7, 'LOTE-ESPAG-001', '2025-01-01', '2026-01-01', 20.000, 18.500, 5500, 'Pasta seca larga vida'),
(8, 'LOTE-HUEVO-001', '2025-01-13', '2025-01-27', 120.000, 98.000, 450, 'Huevos AA bandeja'),
(9, 'LOTE-LIMON-001', '2025-01-14', '2025-01-21', 6.000, 5.200, 3500, 'Limón verde fresco'),
(10, 'LOTE-PAPA-001', '2025-01-10', '2025-01-24', 25.000, 20.000, 1800, 'Papa pastusa cosecha nueva');

-- RECETA
INSERT INTO Receta (id_producto, id_ingrediente, Cantidad_necesaria, Unidad) VALUES
(1, 1, 0.200, 'KG'),   -- Hamburguesa: carne
(1, 4, 0.050, 'KG'),   -- Hamburguesa: lechuga
(1, 5, 0.060, 'KG'),   -- Hamburguesa: tomate
(1, 3, 0.040, 'KG'),   -- Hamburguesa: queso
(2, 2, 0.250, 'KG'),   -- Pizza: harina
(2, 3, 0.150, 'KG'),   -- Pizza: mozzarella
(2, 5, 0.100, 'KG'),   -- Pizza: tomate
(6, 6, 0.250, 'KG'),   -- Pollo plancha: pechuga
(7, 7, 0.200, 'KG'),   -- Carbonara: espagueti
(7, 8, 2.000, 'UNIDAD'); -- Carbonara: huevo
...
(1, 1, 2, 18000, 'ENTREGADO'),
(1, 5, 2, 7000, 'ENTREGADO'),
(2, 2, 1, 32000, 'ENTREGADO'),
(2, 4, 2, 6000, 'ENTREGADO'),
(3, 6, 1, 22000, 'ENTREGADO'),
(3, 10, 1, 7000, 'ENTREGADO'),
(4, 7, 2, 24000, 'PREPARANDO'),
(5, 9, 1, 9000, 'PENDIENTE'),
(5, 3, 1, 14000, 'PENDIENTE'),
(6, 1, 3, 18000, 'ENTREGADO');

-- FACTURA
INSERT INTO Factura (id_pedido, consecutivo, CUFE, IVA, Descuento, Propina, total, estado) VALUES
(1, 'FAC-2025-0001', 'CUFE001abc', 8360, 0, 5000, 59360, 'PAGADA'),
(2, 'FAC-2025-0002', 'CUFE002abc', 8360, 5000, 0, 47360, 'PAGADA'),
(3, 'FAC-2025-0003', 'CUFE003abc', 5510, 0, 0, 34510, 'PAGADA'),
(6, 'FAC-2025-0004', 'CUFE004abc', 10240, 0, 0, 64240, 'PAGADA'),
(7, 'FAC-2025-0005', 'CUFE005abc', 6000, 2000, 3000, 39000, 'PAGADA'),
(9, 'FAC-2025-0006', 'CUFE006abc', 6840, 0, 0, 42840, 'PAGADA'),
(4, 'FAC-2025-0007', 'CUFE007abc', 9120, 0, 0, 57120, 'EMITIDA'),
(8, 'FAC-2025-0008', 'CUFE008abc', 5320, 0, 2000, 33320, 'EMITIDA'),
(2, 'FAC-2025-0009', 'CUFE009abc', 3420, 0, 0, 21420, 'ANULADA'),
(1, 'FAC-2025-0010', 'CUFE010abc', 2000, 0, 0, 14000, 'PAGADA');

-- PAGO
INSERT INTO pago (id_factura, id_usuario_cajero, metodo, monto, referencia, estado, id_turno) VALUES
(1, 3, 'EFECTIVO', 59360, NULL, 'APROBADO', 1),
(2, 3, 'TARJETA_CREDITO', 47360, 'REF-TC-00234', 'APROBADO', 1),
(3, 7, 'NEQUI', 34510, 'NEQ-8845612', 'APROBADO', 2),
(4, 3, 'EFECTIVO', 64240, NULL, 'APROBADO', 3),
(5, 7, 'DAVIPLATA', 39000, 'DAV-9923411', 'APROBADO', 2),
(6, 3, 'TARJETA_DEBITO', 42840, 'REF-TD-00891', 'APROBADO', 1),
(7, 7, 'EFECTIVO', 57120, NULL, 'APROBADO', 4),
(8, 3, 'TARJETA_CREDITO', 33320, 'REF-TC-00567', 'APROBADO', 5),
(9, 7, 'EFECTIVO', 21420, NULL, 'RECHAZADO', 2),
(10, 3, 'PSE', 14000, 'PSE-441231', 'APROBADO', 3);

-- FLUJO_CAJA
INSERT INTO flujo_caja (id_turno, concepto, ingresos, egresos, saldo, metodo, referencia, id_pago) VALUES
(1, 'Apertura de caja', 200000, 0, 200000, 'EFECTIVO', NULL, NULL),
(1, 'Pago factura FAC-2025-0001', 59360, 0, 259360, 'EFECTIVO', NULL, 1),
(1, 'Pago factura FAC-2025-0002', 47360, 0, 306720, 'TARJETA_CREDITO', 'REF-TC-00234', 2),
(1, 'Pago factura FAC-2025-0006', 42840, 0, 349560, 'TARJETA_DEBITO', 'REF-TD-00891', 6),
(2, 'Apertura de caja', 150000, 0, 150000, 'EFECTIVO', NULL, NULL),
(2, 'Pago factura FAC-2025-0003', 34510, 0, 184510, 'NEQUI', 'NEQ-8845612', 3),
(2, 'Pago factura FAC-2025-0005', 39000, 0, 223510, 'DAVIPLATA', 'DAV-9923411', 5),
(3, 'Apertura de caja', 200000, 0, 200000, 'EFECTIVO', NULL, NULL),
(3, 'Pago factura FAC-2025-0004', 64240, 0, 264240, 'EFECTIVO', NULL, 4),
(3, 'Gasto insumos limpieza', 0, 15000, 249240, 'EFECTIVO', 'COMP-001', NULL);

-- DOMICILIO
INSERT INTO domicilio (id_pedido, direccion, coordenadas_gps, estado, fecha_entrega, id_repartidor) VALUES
(3, 'Carrera 7 # 60-15', '4.6200,-74.0700', 'ENTREGADO', '2025-01-15 13:45:00', 5),
(6, 'Av. 68 # 22-10', '4.6300,-74.0900', 'ENTREGADO', '2025-01-15 20:30:00', 8),
(9, 'Calle 100 # 15-05', '4.6800,-74.0500', 'ENTREGADO', '2025-01-14 19:00:00', 5),
(4, 'Calle 72 # 9-40', '4.6550,-74.0650', 'EN_CAMINO', NULL, 8),
(5, 'Kr 19 # 100-20', '4.6900,-74.0450', 'ASIGNADO', NULL, 5),
(7, 'Calle 26 # 30-55', '4.6150,-74.0750', 'ENTREGADO', '2025-01-14 21:15:00', 8),
(1, 'Carrera 30 # 45-10', '4.6400,-74.0800', 'ENTREGADO', '2025-01-15 14:00:00', 5),
(2, 'Calle 53 # 20-35', '4.6480,-74.0720', 'ENTREGADO', '2025-01-15 21:00:00', 8),
(8, 'Calle 45 # 12-30', '4.6097,-74.0817', 'EN_CAMINO', NULL, 5),
(10, 'Carrera 15 # 80-25', '4.6650,-74.0600', 'ASIGNADO', NULL, 8);
...
(1, 1, 20.00, 20.00, 18000),
(2, 3, 10.00, 0.00, 22000),
(3, 4, 5.00, 5.00, 4000),
(3, 5, 8.00, 8.00, 3000),
(4, 7, 15.00, 0.00, 5500),
(5, 2, 30.00, 0.00, 2500),
(6, 1, 15.00, 15.00, 18000),
(7, 4, 4.00, 4.00, 4000),
(8, 8, 60.00, 0.00, 450),
(9, 10, 20.00, 20.00, 1800);
...
(1, 1, 18000, 1, 4.8, true, '2025-01-14 09:00:00'),
(2, 3, 22000, 2, 4.5, true, '2025-01-12 10:00:00'),
(3, 4, 4000, 1, 4.7, true, '2025-01-13 08:00:00'),
(3, 5, 3000, 1, 4.6, true, '2025-01-13 08:00:00'),
(5, 2, 2500, 2, 4.3, true, '2025-01-10 11:00:00'),
(4, 7, 5500, 3, 4.2, true, '2025-01-08 09:00:00'),
(6, 8, 450, 1, 4.9, true, '2025-01-10 08:00:00'),
(9, 6, 14000, 1, 4.7, true, '2025-01-12 09:00:00'),
(10, 9, 3500, 1, 4.5, true, '2025-01-11 10:00:00'),
(10, 10, 1800, 1, 4.4, true, '2025-01-10 10:00:00');
...
(1, 9, 'ENTRADA', 20.000, 18000, 'Compra orden #1', 'ORDEN_COMPRA', 1, 1),
(4, 9, 'ENTRADA', 5.000, 4000, 'Compra orden #3', 'ORDEN_COMPRA', 3, 4),
(5, 9, 'ENTRADA', 8.000, 3000, 'Compra orden #3', 'ORDEN_COMPRA', 3, 5),
(1, 4, 'SALIDA', 0.400, 18000, 'Pedido #1 - 2 hamburguesas', 'PEDIDO', 1, 1),
(6, 6, 'SALIDA', 0.250, 14000, 'Pedido #3 - pollo plancha', 'PEDIDO', 3, 6),
(7, 6, 'SALIDA', 0.400, 5500, 'Pedido #4 - 2 carbonaras', 'PEDIDO', 4, 7),
(8, 6, 'SALIDA', 4.000, 450, 'Pedido #4 - 2 carbonaras', 'PEDIDO', 4, 8),
(2, 9, 'ENTRADA', 50.000, 2500, 'Compra orden #6', 'ORDEN_COMPRA', 6, 2),
(3, 9, 'ENTRADA', 10.000, 22000, 'Compra ord #2 (parcial)', 'ORDEN_COMPRA', 2, 3),
(10, 9, 'ENTRADA', 20.000, 1800, 'Compra orden #9', 'ORDEN_COMPRA', 9, 10);
