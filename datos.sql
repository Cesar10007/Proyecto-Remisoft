SET FOREIGN_KEY_CHECKS = 0; -- Es la opción de ignorar temporalmente las relaciones de las tablas para así insertar los datos
SET NAMES 'utf8mb4'; --  la conexión usa codificación UTF-8 completa. Para caracteres especiales.

-- LIMPIEZA DE TABLAS (orden inverso a FK)
...
TRUNCATE TABLE rol;
-- El comando truncate sirve para borrar los datos de las tablas y así ejecutar el codigo infinidad de veces sin duplicados, ojo esto es para ejercicio todavia no son datos fijos entonces tenemos que cuadrar este tema
...
(1, 3, 0.040, 'KG'),      -- Hamburguesa: queso mozzarella
