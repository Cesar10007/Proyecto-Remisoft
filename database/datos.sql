...
-- Limpieza completa de datos dependientes y maestros.
...
(5, '1008', 'Isabella', 'Vargas', 'isabella.vargas@resto.com', '3156667778', '$2y$12$NbBh9iRrnzVgmwp8oqHCz.1YuDlCnWqYEGTh/u8pnVkkZzbKe', 1),
...
-- Validaciones finales: no debe existir el rol de usuario CLIENTE.
SELECT id_rol, nombre, descripcion
FROM rol
ORDER BY id_rol;

SELECT COUNT(*) AS usuarios_con_rol_cliente
FROM usuario
WHERE id_rol = 6
   OR id_rol IN (
       SELECT id_rol
